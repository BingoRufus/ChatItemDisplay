...
import com.github.bingorufus.chatitemdisplay.util.iteminfo.ItemStackReflection;
import com.github.bingorufus.chatitemdisplay.util.iteminfo.ItemStackStuff;
...
public class DisplayItemInfo implements DisplayInfo {
    ...
    public TextComponent baseHover() {
        String color = new StringFormatter().format(m.getConfig().getString("messages.item-color"));
